  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      username: "Priya Nair",
      handle: "@priyanair",
      content: "Eigensu shipped a clean, reliable build without the usual drama. Communication was crisp and timelines held. 👌",
      date: "Feb 2, 2026",
      verified: true,
      likes: 87,
      retweets: 12,
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1502767089025-6572583495b0?w=400&auto=format&fit=crop&q=80",
      username: "Luis Ortega",
      handle: "@luis_ortega",
      content: "Migration + hardening done in weeks, not months. Zero downtime and my SRE team actually slept. 🚀",
      date: "Jan 28, 2026",
      verified: true,
      likes: 64,
      retweets: 17,
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1544723795-3fb6469f5b39?w=400&auto=format&fit=crop&q=80",
      username: "Emily Hart",
      handle: "@emhart_ops",
      content: "We asked for enterprise polish and got it. Observability, access controls, and docs were all first-class.",
      date: "Jan 18, 2026",
      verified: true,
      likes: 131,
      retweets: 29,
